...
export class DeviceService {
  ...
  static async removeDevice(
    ...
    // If actingDeviceId is provided, verify it is a trusted device and signature matches
    ...
    } else if (actingDeviceId) {
      throw new Error(
        "Missing cryptographic signature headers for device action.",
      );
    }
