    ...
    <SafeAreaView className="flex-1 bg-white dark:bg-[#09090b]">
     <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="px-6 py-12">
      <View className="flex-1 items-center justify-center">
       <View className="mb-8 h-24 w-24 items-center justify-center rounded-3xl bg-red-500/10 dark:bg-red-500/20 shadow-xl shadow-red-500/10">
       ...
       <View className="w-full rounded-2xl bg-zinc-50 p-5 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800">
        <Text className="mb-2 font-semibold text-zinc-900 dark:text-zinc-100">
         Quick Recovery
        </Text>
        <Text className="text-sm text-zinc-500 dark:text-zinc-400">
         Try restarting the application to resolve the issue. If the problem persists, please contact support.
        </Text>
       </View>
