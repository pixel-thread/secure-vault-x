          ...
          {selectedSecret && (
            <>
              ...
              <ScrollView showsVerticalScrollIndicator={false} className="mb-2">
                {isEditing && selectedSecret.type === 'password' ? (
                  <AddPasswordForm
                    mode="edit"
                    initialValues={{
                      id: selectedSecret.id,
                      serviceName: selectedSecret.serviceName,
                      url: (selectedSecret as any).website ?? '',
                      username: (selectedSecret as any).username ?? '',
                      password: (selectedSecret as any).secretInfo ?? '',
